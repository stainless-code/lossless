...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic. See the type-system-discipline and boundary-discipline sections of [`principles/REFERENCE.md`](../principles/REFERENCE.md).
...
Validate once where data crosses in. Trust types inside. See [boundary-discipline](../principles/REFERENCE.md#boundary-discipline).
